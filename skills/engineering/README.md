...
- **[tooling-feedback](./tooling-feedback/SKILL.md)** — Treat actionable compiler, linter, language-server, and framework diagnostics on touched code as implementation feedback.
- **[scrutinize](./scrutinize/SKILL.md)** — Outsider-perspective end-to-end review of a plan, PR, or code change.
- **[rubberduck](./rubberduck/SKILL.md)** — Think through a problem interactively before touching code.
- **[reviewer](./reviewer/SKILL.md)** — Review code and diffs without silently becoming the implementer.
- **[minimalist](./minimalist/SKILL.md)** — Make the smallest correct change and leave adjacent code alone.
